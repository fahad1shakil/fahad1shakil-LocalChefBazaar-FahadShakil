...
const About = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-[#05070a] text-slate-900 dark:text-white pb-32 transition-colors duration-500">
      <section className="relative h-[65vh] flex items-center justify-center overflow-hidden mb-20">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/50 dark:via-[#05070a]/50 to-white dark:to-[#05070a] z-20" />
        <motion.div 
        ...
        {/* Subtle Glows */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#6db70e]/10 rounded-full blur-[120px] animate-pulse z-0" />
        
        <div className="relative z-30 text-center px-6">
          <motion.h4 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-[#6db70e] text-[10px] font-black uppercase tracking-[0.8em] mb-4"
          >
            Bazaar Heritage
          </motion.h4>
          <motion.h1 
          ...
          >
            OUR <span className="text-[#6db70e]">STORY</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <section className="px-6 md:px-24 mb-40">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-[#6db70e] text-[10px] font-black uppercase tracking-[0.5em] mb-4 block">The Philosophy</span>
            <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-8">Revolutionizing the Art of <span className="text-[#6db70e]">Everyday Dining</span></h2>
            ...
            <div className="space-y-4">
              {['Bespoke Ingredient Sourcing', 'Heritage Recipe Preservation', 'Sustainable Elite Logistics'].map((item, i) => (
                <div key={i} className="flex items-center gap-3">
                  <FiCheckCircle className="text-[#6db70e]" />
          ...
          <div className="grid grid-cols-2 gap-6">
            <motion.div 
              ...
              className="h-[500px] rounded-[3rem] bg-slate-100 dark:bg-white/5 overflow-hidden"
            >
            ...
            <motion.div 
              ...
              className="h-[400px] rounded-[3rem] bg-slate-100 dark:bg-white/5 overflow-hidden mt-20"
            >
      ...
      {/* Stats Bar */}
      <section className="px-6 md:px-24 mb-40">
        <div className="bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-[3rem] p-16 backdrop-blur-md">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
            {stats.map((stat, i) => (
              <div key={i} className="text-center">
                <div className="text-[#6db70e] text-3xl mb-4 flex justify-center">{stat.icon}</div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            {milestones.map((m, i) => (
              ...
              >
                <div className="w-24 text-2xl font-black tracking-tighter text-[#6db70e] opacity-40 group-hover:opacity-100 transition-opacity">{m.year}</div>
                <div className="flex-1 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 p-8 rounded-[2rem] group-hover:border-[#6db70e]/40 transition-all">
                  <h4 className="text-xl font-black uppercase tracking-tight mb-2">{m.title}</h4>
                  <p className="text-slate-500 dark:text-slate-400 text-sm italic">"{m.description}"</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="mt-40 text-center px-6">
        ...
        >
          JOIN THE <span className="text-[#6db70e]">COLLECTIVE</span>
        </motion.h2>
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          ...
          <Link to="/chefs">
            <button className="px-12 py-5 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white font-black rounded-full text-xs uppercase tracking-[0.3em] hover:bg-white hover:text-black transition-all">
              Meet The Masters
            </button>
          </Link>
        </div>
