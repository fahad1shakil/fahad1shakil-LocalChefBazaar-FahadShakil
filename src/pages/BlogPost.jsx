...
const BlogPost = () => {
  ...
  const blogPosts = [
    {
      ...
      content: `
        ...
        <h2 style="font-weight: 900; font-size: 2rem; margin-top: 2rem; margin-bottom: 1rem; color: #0f172a;">The Panch Phoron Magic</h2>
        ...
        <h3 style="font-weight: 800; font-size: 1.5rem; margin-top: 1.5rem; color: #6db70e;">The Art of Tempering</h3>
        ...
        <blockquote style="border-left: 4px solid #6db70e; padding-left: 20px; font-style: italic; font-family: serif; font-size: 1.5rem; margin: 2rem 0; color: #475569;">
          "Spices in a Bengali kitchen are not just ingredients; they are the storyteller of our ancestors' journeys."
        </blockquote>
        <h2 style="font-weight: 900; font-size: 2rem; margin-top: 2rem; margin-bottom: 1rem; color: #0f172a;">Layering Powdered Spices</h2>
    ...
    },
    {
      ...
      content: `
        ...
        <h2 style="font-weight: 900; font-size: 2rem; margin-top: 2rem; margin-bottom: 1rem; color: #0f172a;">The Morning Harvest Cycle</h2>
        ...
        <h3 style="font-weight: 800; font-size: 1.5rem; margin-top: 1.5rem; color: #6db70e;">The Sustainable Difference</h3>
    ...
    },
    {
      ...
      content: `
        ...
        <h2 style="font-weight: 900; font-size: 2rem; margin-top: 2rem; margin-bottom: 1rem; color: #0f172a;">The Rice: The Long and Short of It</h2>
        ...
        <h3 style="font-weight: 800; font-size: 1.5rem; margin-top: 1.5rem; color: #6db70e;">The Saffron Alchemy</h3>
    ...
    },
    {
      ...
      content: `
        ...
        <h2 style="font-weight: 900; font-size: 2rem; margin-top: 2rem; margin-bottom: 1rem; color: #0f172a;">Reducing Culinary Carbon</h2>
        ...
        <h3 style="font-weight: 800; font-size: 1.5rem; margin-top: 1.5rem; color: #6db70e;">Zero-Waste Techniques</h3>
    ...
    },
    {
      ...
      content: `
        ...
        <h2 style="font-weight: 900; font-size: 2rem; margin-top: 2rem; margin-bottom: 1rem; color: #0f172a;">The Microbiome of Your Starter</h2>
        ...
        <h3 style="font-weight: 800; font-size: 1.5rem; margin-top: 1.5rem; color: #6db70e;">The Magic of Oven Spring</h3>
    ...
    },
    {
      ...
      content: `
        ...
        <h2 style="font-weight: 900; font-size: 2rem; margin-top: 2rem; margin-bottom: 1rem; color: #0f172a;">The Kacchi King of Nazira Bazar</h2>
        ...
        <h3 style="font-weight: 800; font-size: 1.5rem; margin-top: 1.5rem; color: #6db70e;">Iconic Bites</h3>
    ...
    },
    {
      ...
      content: `
        ...
        <h2 style="font-weight: 900; font-size: 2rem; margin-top: 2rem; margin-bottom: 1rem; color: #0f172a;">The Anatomy of a High-Energy Bowl</h2>
        ...
        <h3 style="font-weight: 800; font-size: 1.5rem; margin-top: 1.5rem; color: #6db70e;">Busy Morning Prep</h3>
    ...
    },
    {
      ...
      content: `
        ...
        <h2 style="font-weight: 900; font-size: 2rem; margin-top: 2rem; margin-bottom: 1rem; color: #0f172a;">The Science of Braising</h2>
        ...
        <h3 style="font-weight: 800; font-size: 1.5rem; margin-top: 1.5rem; color: #6db70e;">Essential Rules</h3>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          ...
          <p className="text-slate-500 mb-8 font-medium">The culinary story you're looking for has moved to a new season.</p>
          <Link to="/blog">
            <button className="px-10 py-4 bg-[#6db70e] text-white font-black rounded-full uppercase text-xs tracking-widest shadow-xl">
              Back to Journal
            </button>
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[60vh] md:h-[70vh] w-full overflow-hidden flex items-end pb-12 md:pb-0">
        <motion.img 
          initial={{ scale: 1.1 }}
          animate={{ scale: 1 }}
        ...
        <div className="relative w-full px-6 md:p-10 lg:p-24 z-10 pt-32">
          <div className="max-w-5xl">
            <Link to="/blog">
              <motion.button 
                whileHover={{ x: -5 }}
                className="flex items-center gap-2 text-[#6db70e] font-black text-[10px] uppercase tracking-[0.4em] mb-6 md:mb-8"
              >
            ...
            >
              <div className="flex flex-wrap items-center gap-3 md:gap-4 mb-4 md:mb-6">
                <span className="px-4 py-1.5 bg-[#6db70e] text-white text-[10px] font-black uppercase tracking-widest rounded-full">
                  {post.category}
                </span>
                <div className="flex items-center gap-3 md:gap-4 text-slate-900 font-black text-[9px] md:text-[10px] uppercase tracking-widest opacity-60">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black text-slate-900 tracking-tighter leading-[1.1] mb-6 md:mb-8">
                {post.title}
              </h1>
            </motion.div>
          </div>
      ...
      <section className="py-12 md:py-24 px-6 md:px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16">
          ...
          <div className="lg:col-span-8">
            <article className="prose prose-lg md:prose-2xl max-w-none prose-slate">
              <div 
                className="font-medium text-slate-600 leading-relaxed text-lg md:text-xl"
                dangerouslySetInnerHTML={{ __html: post.content }} 
              />
            </article>

            {/* Premium Author Card */}
            <div className="mt-16 md:mt-24 p-8 md:p-12 bg-slate-50 rounded-[2.5rem] md:rounded-[3rem] border border-slate-100 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-10">
              <img src={post.authorImage} alt={post.author} className="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover border-4 border-white shadow-xl" />
              <div className="text-center md:text-left flex-1">
                <span className="text-[#6db70e] text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em] mb-2 block">Featured Expert</span>
                <h3 className="text-2xl md:text-3xl font-black text-slate-900 mb-4">{post.author}</h3>
                ...
                <div className="flex gap-4 mt-6 justify-center md:justify-start">
                  <button className="p-3 bg-white rounded-full text-slate-400 hover:text-[#6db70e] transition-all shadow-sm"><FiShare2 /></button>
                </div>
              </div>
            </div>
          </div>
          ...
          <aside className="lg:col-span-4 flex flex-col gap-10">
            <div className="bg-slate-900 p-10 rounded-[3rem] text-white overflow-hidden relative">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#6db70e]/20 rounded-full blur-3xl" />
              <h4 className="text-2xl font-black mb-6 tracking-tight relative z-10">Stay Inspired</h4>
              <p className="text-slate-400 mb-8 font-medium text-sm leading-relaxed relative z-10">
                Join our private community and receive master-chef secrets and early access to our seasonal specials.
              </p>
              <div className="relative z-10">
                <input type="email" placeholder="Email address" className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-full mb-4 text-white focus:outline-none focus:border-[#6db70e]" />
                <button className="w-full py-4 bg-[#6db70e] text-white font-black rounded-full uppercase text-[10px] tracking-widest hover:bg-[#7cd112] transition-all cursor-pointer">Subscribe Now</button>
              </div>
            </div>

            <div className="p-10 bg-white rounded-[3rem] border border-slate-100 shadow-sm">
              <h4 className="text-xl font-black text-slate-900 mb-8 tracking-tight">Recent Stories</h4>
              <div className="space-y-8">
                {blogPosts.slice(0, 4).map((p) => (
                  <Link key={p.id} to={`/blog/${p.id}`} onClick={scrollToTop} className="group flex gap-4 items-center">
                    ...
                    <div>
                      <h5 className="font-black text-slate-900 text-sm leading-tight group-hover:text-[#6db70e] transition-all line-clamp-2">{p.title}</h5>
                      <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-2 block">{p.date}</span>
                    </div>
                  </Link>
                ))}
              </div>
      ...
      <section className="py-20 bg-white border-t border-slate-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <Link to="/blog" onClick={scrollToTop}>
            <button className="group flex items-center gap-4 mx-auto text-slate-400 hover:text-slate-900 transition-all cursor-pointer">
              <span className="font-black text-xs uppercase tracking-[0.5em]">Explore Full Journal</span>
              <div className="w-10 h-10 rounded-full border border-slate-100 flex items-center justify-center group-hover:border-[#6db70e] group-hover:bg-[#6db70e] group-hover:text-white transition-all">
                <FiArrowRight />
              </div>
            </button>
          </Link>
