...
const Faq = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0f0f0f] text-slate-900 dark:text-[#e0e0e0] pb-32 transition-colors duration-500">
      {/* Cinematic Hero */}
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden mb-20 bg-slate-50 dark:bg-[#0f0f0f]">
        ...
        <div className="relative z-20 text-center px-6">
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-7xl font-black tracking-tighter mb-8 text-slate-900 dark:text-[#e0e0e0]"
          >
            KNOWLEDGE <span className="text-[#6db70e] dark:text-[#7ecf55]">HUB</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.4 }}
            className="text-slate-500 dark:text-[#888888] text-lg font-serif italic max-w-2xl mx-auto leading-relaxed"
          >
      ...
      <div className="max-w-4xl mx-auto px-6">
            ...
            >
              <button 
                ...
                className={`w-full text-left p-8 rounded-[2.5rem] border transition-all duration-500 flex justify-between items-center ${
                  activeTab === index 
                    ? 'bg-[#6db70e] dark:bg-[#7ecf55] border-[#6db70e] dark:border-[#7ecf55] text-black dark:text-[#0f0f0f] shadow-2xl scale-[1.02]' 
                    : 'bg-slate-50 dark:bg-[#111111] border-slate-200 dark:border-[#242424] dark:border-[0.5px] text-slate-900 dark:text-[#e0e0e0] hover:border-[#7ecf55]/40'
                }`}
              >
                <span className="text-lg font-black tracking-tight">{faq.question}</span>
                <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
                  activeTab === index ? 'bg-black dark:bg-[#0f0f0f] text-[#6db70e] dark:text-[#7ecf55]' : 'bg-[#6db70e]/10 dark:bg-[#7ecf55]/10 text-[#6db70e] dark:text-[#7ecf55]'
                }`}>
              ...
              {activeTab === index && (
                <motion.div
                  ...
                  className="px-10 py-8 text-slate-500 dark:text-[#888888] text-sm leading-relaxed italic"
                >
                  "{faq.answer}"
                </motion.div>
              )}
        ...
        {/* Support CTA */}
        <section className="mt-32 p-16 bg-slate-900 dark:bg-[#111111] rounded-[3.5rem] text-center relative overflow-hidden shadow-2xl border dark:border-[#242424] dark:border-[0.5px]">
          <div className="absolute inset-0 bg-[#6db70e]/5 dark:bg-[#7ecf55]/5 animate-pulse" />
          <div className="relative z-10">
            <FiHelpCircle className="text-4xl text-[#6db70e] dark:text-[#7ecf55] mx-auto mb-6" />
            <h3 className="text-3xl font-black tracking-tighter text-white dark:text-[#e0e0e0] mb-4">STILL HAVE QUESTIONS?</h3>
            <p className="text-slate-400 dark:text-[#888888] mb-8 max-w-lg mx-auto">Our senior concierge team is available 24/7 to assist with your bespoke culinary requirements.</p>
            <button className="px-12 py-5 bg-[#6db70e] dark:bg-[#7ecf55] text-black dark:text-[#0f0f0f] font-black rounded-full text-xs uppercase tracking-[0.3em] hover:bg-white dark:hover:bg-white transition-all shadow-[0_20px_40px_rgba(109,183,14,0.3)]">
