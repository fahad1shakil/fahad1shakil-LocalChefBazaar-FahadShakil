    ...
    <section className="py-24 px-6 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-80 h-80 bg-[#6db70e]/20 rounded-full blur-3xl -mr-32 -mt-32 group-hover:bg-[#6db70e]/30 transition-all duration-1000" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-emerald-500/10 rounded-full blur-2xl -ml-20 -mb-20 group-hover:bg-[#6db70e]/20 transition-all duration-1000" />
          
          <div className="relative z-10 text-center flex flex-col items-center">
            <span className="text-[#6db70e] text-xs font-black uppercase tracking-[0.5em] mb-4 block">International Flavors</span>
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tighter leading-tight">
              Explore Global <span className="text-[#6db70e]">Cuisines</span>
            </h2>
          ...
          {categories.map((category, index) => (
            ...
            >
              <div className="absolute inset-0">
                ...
                />
                <div className={`absolute inset-0 bg-gradient-to-t ${category.color} opacity-40 group-hover:opacity-60 transition-opacity duration-500`}></div>
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-slate-900/90 group-hover:to-slate-900 transition-all duration-500"></div>
              </div>
              
              <div className="absolute inset-0 flex flex-col justify-end p-6 text-white z-10">
                <span className="text-[#6db70e] text-[10px] font-black uppercase tracking-widest mb-1 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                  {category.count}
                </span>
                <h3 className="text-xl font-black mb-3 tracking-tight group-hover:text-[#6db70e] transition-colors duration-300">
                  {category.name}
                </h3>
                ...
                <Link to="/allmeals" className="translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                  <button className="px-5 py-2 bg-white/10 backdrop-blur-md text-white border border-white/20 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-[#6db70e] hover:border-[#6db70e] transition-all duration-300">
                    Explore
                  </button>
                </Link>
              </div>
